...
class TcMedia001:
    ...
    def run(self):
        """运行测试"""
        self.log(f"开始测试: 媒体播放控制测试")
        self.log(f"描述: 测试媒体播放的基本控制功能")
            ...
            steps = [
        {
            'id': '1',
            'name': '进入媒体界面',
            'actions': [{'type': 'click_image', 'imageId': 'media_icon'}, {'type': 'wait', 'duration': '3000'}, {'type': 'verify_image', 'imageId': 'media_screen', 'timeout': '5000'}]
        },
        {
            'id': '2.1',
            'name': '第1次播放控制',
            'actions': [{'type': 'click_image', 'imageId': 'play_button'}, {'type': 'wait', 'duration': '2000'}, {'type': 'click_image', 'imageId': 'next_button'}, {'type': 'wait', 'duration': '3000'}, {'type': 'click_image', 'imageId': 'volume_up'}, {'type': 'wait', 'duration': '1000'}, {'type': 'click_image', 'imageId': 'volume_down'}, {'type': 'wait', 'duration': '1000'}]
        },
        {
            'id': '2.2',
            'name': '第2次播放控制',
