...
class TcClimate001:
    ...
    def run(self):
        """运行测试"""
        self.log(f"开始测试: 空调控制测试")
        self.log(f"描述: 测试空调温度调节功能")
            ...
            steps = [
        {
            'id': '1',
            'name': '进入空调界面',
            'actions': [{'type': 'click_image', 'imageId': 'climate_icon'}, {'type': 'wait', 'duration': '2000'}, {'type': 'verify_image', 'imageId': 'climate_screen', 'timeout': '5000'}]
        },
        {
            'id': '2',
            'name': '升高温度',
        ...
        },
        {
            'id': '3',
            'name': '开启座椅加热',
            'actions': [{'type': 'click_image', 'imageId': 'seat_heating'}, {'type': 'wait', 'duration': '1000'}, {'type': 'verify_image', 'imageId': 'seat_heating', 'timeout': '2000'}]
        },
        {
            'id': '4',
            'name': '智能温度调节',
        ...
        },
        {
            'id': '5',
            'name': '返回主界面',
            'actions': [{'type': 'press_key', 'key': 'BACK'}, {'type': 'wait', 'duration': '1000'}, {'type': 'press_key', 'key': 'HOME'}, {'type': 'wait', 'duration': '2000'}, {'type': 'verify_image', 'imageId': 'home_icon', 'timeout': '3000'}]
        }
]
