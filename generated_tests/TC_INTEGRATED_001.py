...
class TcIntegrated001:
    ...
    def run(self):
        """运行测试"""
        self.log(f"开始测试: 综合场景测试")
        self.log(f"描述: 综合测试多个功能切换")
            ...
            steps = [
        {
            'id': '1',
            'name': '启动导航',
            'actions': [{'type': 'click_image', 'imageId': 'nav_icon'}, {'type': 'wait', 'duration': '3000'}, {'type': 'click_image', 'imageId': 'cancel_navigation'}, {'type': 'wait', 'duration': '1000'}, {'type': 'press_key', 'key': 'HOME'}, {'type': 'wait', 'duration': '2000'}]
        },
        {
            'id': '2',
            'name': '播放媒体',
            'actions': [{'type': 'click_image', 'imageId': 'media_icon'}, {'type': 'wait', 'duration': '3000'}, {'type': 'click_image', 'imageId': 'play_button'}, {'type': 'wait', 'duration': '2000'}, {'type': 'press_key', 'key': 'HOME'}, {'type': 'wait', 'duration': '2000'}]
        },
        {
            'id': '3',
            'name': '调节空调',
            'actions': [{'type': 'click_image', 'imageId': 'climate_icon'}, {'type': 'wait', 'duration': '2000'}, {'type': 'click_image', 'imageId': 'temp_up'}, {'type': 'wait', 'duration': '500'}, {'type': 'press_key', 'key': 'HOME'}, {'type': 'wait', 'duration': '2000'}]
        },
        {
            'id': '4',
            'name': '最终验证',
            'actions': [{'type': 'verify_image', 'imageId': 'home_icon', 'timeout': '3000'}, {'type': 'log', 'message': '所有功能切换测试完成'}]
        }
]
